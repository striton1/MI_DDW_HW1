...
print("Binary representation x Cosine similarity measure")
print("Precision= " + str(precision))
print("Recall= " + str(recall))
print("F-measure= " + str( calculate_f_measure(precision, recall)))
separator();
...
print("Binary representation x Euclidean distance")
print("Precision= " + str(precision))
print("Recall= " + str(recall))
print("F-measure= " + str( calculate_f_measure(precision, recall)))
separator();
...
print("TF-IDF x Cosine similarity measure")
print("Precision: " + str(precision))
print("Recall: " + str(recall))
print("F-measure: " + str( calculate_f_measure(precision, recall)))
separator();
...
print("TF-IDF x Euclidean distance")
print("Precision: " + str(precision))
print("Recall: " + str(recall))
print("F-measure: " + str( calculate_f_measure(precision, recall)))
separator();
